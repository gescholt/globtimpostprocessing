...
The primary workflow: load raw critical points from `globtim` and refine them.
...
# 1. Refine critical points from globtim output
...
```julia
using Pkg
Pkg.test("GlobtimPostProcessing")
```
