...
# Explicit owned bindings: PrettyTables v3 does not export these top-level
# names, so `using PrettyTables` alone leaves them unresolved at runtime.
using PrettyTables: Highlighter, tf_unicode_rounded, ft_printf
...
export validate_newton_steps, compute_newton_step_norms
export StepNormValidationResult
...
export classify_eigenvalues

# Modular refinement method exports
export RefinementMethod
export NewtonCP, NewtonMinimize
export OptimNelderMead, OptimLBFGS, OptimBFGS, OptimConjugateGradient, OptimGradientDescent
export refinement_method, refine_point, refine_points
export method_name, needs_gradient, needs_hessian
...
export detect_valley, project_to_valley, project_to_valley_tangent, get_valley_tangent
export trace_valley, trace_valleys_from_critical_points
export walk_newton_projection, walk_predictor_corrector, walk_tangent_projection
export run_valley_analysis

# Subdivision tree analysis exports (load + analyze saved JLD2/JSON trees)
...
# Tree display exports (live terminal display during adaptive_refine)
export TreeDisplayConfig
export make_tracker, live_tracker
export print_summary, print_legend
export print_tree_compact, print_tree_summary_only, print_tree_auto
export print_volume_distribution
export progress_bar, format_error, format_time, compute_display_error
export count_splits_per_dim, get_path_to_root, format_path_compact
...
include("refinement/methods.jl")               # Modular refinement method types + factory
include("refinement/unified_dispatch.jl")      # Unified refine_point dispatch
...
# Tree display (live terminal display during adaptive_refine - promoted March 2026)
include("TreeDisplay.jl")
...
using .UnifiedPipeline:
    ExperimentType, LV4DType, DeuflhardType, FitzHughNagumoType, UnknownType
...
using .UnifiedPipeline:
    degree_results, critical_points, has_critical_points, available_degrees
