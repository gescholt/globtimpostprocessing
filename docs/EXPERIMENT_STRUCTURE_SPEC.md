...
This document defines the standardized file structure for globtim HPC experiment outputs and the TDD implementation plan for enhanced parameter display during post-processing.
